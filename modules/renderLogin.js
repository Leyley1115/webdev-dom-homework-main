...
export const renderLogin = () => {
    ...
    <div class="form">
    <label><input type="text" class="input-form" placeholder="Логин" id="log-id"></label>
    <label><input type="text" class="input-form" placeholder="Пароль" id ="password-id"></label>
    </div>
